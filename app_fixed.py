"""
Production-Ready Dash Authentication Dashboard
==============================================

This implementation uses centralized state management to avoid
duplicate callback outputs and nonexistent input errors.

Key Features:
- Single source of truth for authentication state
- Dynamic layout rendering without callback conflicts
...
# =============================================================================
# SOLUTION 1: CENTRALIZED STATE MANAGEMENT WITH DCC.STORE
# =============================================================================
...
# Login callback - only handles login
@app.callback(
...
# Logout callback - only active when dashboard is shown
@app.callback(
    [Output('auth-store', 'data'),
     Output('ui-store', 'data')],
...
def handle_logout(logout_clicks, auth_data):
    """
    Handle logout - only runs when logout button exists.
    """
    if logout_clicks:
        logger.info("Logout triggered")
        return {'authenticated': False, 'username': None}, {'current_layout': 'auth', 'message': ''}
    
    return auth_data, {'current_layout': 'dashboard', 'message': ''}
...
# =============================================================================
# CHART UPDATE CALLBACKS (NO CONFLICTS)
# =============================================================================
