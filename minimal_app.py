"""
MINIMAL: Insurance Dashboard for Vercel
======================================
Absolute minimal version for Vercel deployment
"""
...
app.layout = html.Div([
    ...
    html.Div([
        ...
        ], style={'backgroundColor': 'rgba(0,123,255,0.8)', 'padding': '20px', 'borderRadius': '10px', 'margin': '10px', 'width': '200px'}),
        
        html.Div([
            html.H3(f"${df['charges'].mean():,.0f}", style={'color': 'white', 'textAlign': 'center'}),
            html.P("Avg Charges", style={'color': 'white', 'textAlign': 'center'})
        ], style={'backgroundColor': 'rgba(40,167,69,0.8)', 'padding': '20px', 'borderRadius': '10px', 'margin': '10px', 'width': '200px'}),
        
        html.Div([
            html.H3(f"{df['age'].mean():.1f}", style={'color': 'white', 'textAlign': 'center'}),
            html.P("Avg Age", style={'color': 'white', 'textAlign': 'center'})
        ], style={'backgroundColor': 'rgba(23,162,184,0.8)', 'padding': '20px', 'borderRadius': '10px', 'margin': '10px', 'width': '200px'}),
        
        html.Div([
            html.H3(f"{df['bmi'].mean():.1f}", style={'color': 'white', 'textAlign': 'center'}),
            html.P("Avg BMI", style={'color': 'white', 'textAlign': 'center'})
        ], style={'backgroundColor': 'rgba(255,193,7,0.8)', 'padding': '20px', 'borderRadius': '10px', 'margin': '10px', 'width': '200px'})
...
], style={'backgroundColor': '#667eea', 'minHeight': '100vh', 'padding': '20px'})
